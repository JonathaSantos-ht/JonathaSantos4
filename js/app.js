...
// js/app.js — Atividade 2 (sem SPA)
(function(){
  document.addEventListener("DOMContentLoaded", () => {
    const STRICT_CPF = false;
    initFormValidation();
    wireGlobalHandlers();
  });
  ...
  function initFormValidation(){
    ...
    form.addEventListener("submit", (e)=>{
      ...
      const cpfValid = cpfFmt && (typeof STRICT_CPF!=="undefined" && STRICT_CPF ? cpfAlg : true);
      ok = req(cpf, cpfValid) && ok;
      ...
      // e.preventDefault(); // mantenho envio padrão desativado por ora
      form.reset();
    }, { once: false });
  }
...
// ====== Máscaras automáticas: CPF e CEP (robusta) ======
(function(){
  ...
  function attachMask(inputEl, formatter){
    ...
    // aplica já (caso usuário cole tudo de uma vez)
    apply();
